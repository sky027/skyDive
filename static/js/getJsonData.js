...
function getBirthday(){
	var birth = "";
	var y = Math.floor(Math.random() * 41) + 1979;
...
function getArrData(n){
	...
	for(var i=0;i<n;i++){
		var data = {
			...
			"nations": getNations("str"),
			"previce": getPrevice("str"),
			"phone": getPhoneNum()
		};
		jsonArr.push(data);
	}
